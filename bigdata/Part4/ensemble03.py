...
9절. 앙상블
 ...
 3. AdaBoost : AdaBoost는 사이킷런의 서브패키지 ensemble 내 클래스 AdaBoostClassifier(), AdaBoostRegressor() 등을 통해
 모형객체를 생성할 수 있다. 클래스들의 사용법은 아래와 같으며, AdaBoostClassifier는 이진분류와 다지분류, AdaBoostRegressor는 연속형
 에 사용된다.
