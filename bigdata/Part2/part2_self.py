...
# weight = exam4['Weight']
# # print(weight)
# mms = (weight - weight.min()) / (weight.max() - weight.min())
# # print(mms)
...
# # comb1 = exam5['Manufacturer','Origin']('Origin').duplicate()
# comb1 = exam5[['Manufacturer', 'Origin']].drop_duplicates()
# cntcomb1 = comb1.shape[0]
# # print(exam5[['Manufacturer', 'Origin']])
...
# # print(exam6['Man_trans_avail'])
# """ 내가 적은 못난이 코드 ㅋㅋㅋ
# rpmcnt = exam6['Type','Man_trans_avail']('RPM').count()
# rpmsum = exam6['Type','Man_trans_avail']('RPM').sum()
# rpmmid = exam6['Type','Man_trans_avail']('RPM').median()
# """
...
# # wb = exam7['Wheelbase'] 코드가 지저분해!
# # rpm = exam7['RPM']
# rpm_avg = exam7['RPM'].mean()
# exam7['RPM'] = exam7['RPM'].fillna(rpm_avg)
# # print(rpm)

# # rpmz, wbz z-점수 표준화 공식을 몰러, 쓰벌!
