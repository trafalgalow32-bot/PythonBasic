...
img = cv2.imread("afterMay/opencv_study/images/cat.png")
...
cv2.imwrite("afterMay/opencv_study/images/copy_cat.png", copy_img)
cv2.waitKey(0)
...
# cv2.imwrite("afterMay/opencv_study/images/copy_cat2.png", copy_img2)
# cv2.waitKey(0)
...
cv2.imwrite('afterMay/opencv_study/images/cut_cat.png', cut)
cv2.imshow("cut",cut)
cv2.waitKey(0)