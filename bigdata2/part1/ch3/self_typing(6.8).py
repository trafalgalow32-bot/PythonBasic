...
# # exam23 = pd_
# # case1 = exam23.groupby('결제종류')['실제도착시간']
# # case2 = exam23.groupby('결제종류')['예상도착시간']
...
# # exam4 = exam4['views'].fillna(0) # 이렇게 쓰면 exam4 데이터프레임 모두가 변함...
# # print(exam4.head(30))
# # top10 = exam4['views']
...
# cond1 = exam16['views'] < q1 - (iqr * 1.5)
# cond2 = exam16['views'] > q3 + (iqr * 1.5)
# result = exam16['views'][(cond1)|(cond2)].sum() # 다 구해놓고.... 연산자 &| 를 헷갈려 버리냐 ㅡㅡ;;
# print(int(result))